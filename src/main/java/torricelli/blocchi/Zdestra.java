...
public class Zdestra extends Blocco{

	public Zdestra(GridPane griglia, boolean[][] occupied) {
		...
		for (int i = 0; i < super.pane.length; i++) {
			...
			super.pane[i].setBackground(new Background(new BackgroundFill(Color.GREEN, null, null)));
		}
