...
public class Lsinistra extends Blocco {

	public Lsinistra(GridPane griglia, boolean[][] occupied) {
		...
		for (int i = 0; i < super.pane.length; i++) {
			...
			super.pane[i].setBackground(new Background(new BackgroundFill(Color.ORANGE, null, null)));
		}
