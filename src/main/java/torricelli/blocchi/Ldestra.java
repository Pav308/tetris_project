...
public class Ldestra extends Blocco {

	public Ldestra(GridPane griglia, boolean[][] occupied) {
		...
		for (int i = 0; i < super.pane.length; i++) {
			...
			super.pane[i].setBackground(new Background(new BackgroundFill(Color.BLUE, null, null)));
		}
